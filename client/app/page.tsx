...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    fetch('/animations/playful-sparkles.json')
      .then(res => res.json())
    ...
    <PageContainer>
      ...
      <main className="pb-10">
        <div className="flex flex-col items-center justify-center min-h-[85vh] text-center px-4 relative overflow-hidden">
          ...
          {/* Lottie Animation - Playful Sparkles */}
          {animationData && (
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl h-full max-h-2xl opacity-30 pointer-events-none z-0">
              <Lottie 
